...
<head>
  ...
  <script type="text/javascript" src="${re.contextPath}/ftl/section/departmentApply/js/department_apply.js" charset="utf-8"></script>
   <style>
   	html,body{
   		height: 100%;
   	}
...
<body style="background-color: #E0E0E0">
      ...
      <div class="layui-row"  style="height: 10%;overflow: auto;" >
          ...
          <div class="layui-col-md12"  >
           ...
           <!--  新增按钮
            <button class="layui-btn layui-btn-sm"onclick="add()" style="margin-left:3%;">
            	<i class="layui-icon">&#xe61f;</i>  
                                      新增
            </button> -->
            
            <!--导出-->
            <button class="layui-btn layui-btn-sm"onclick="expor()" style="margin-left:3%;">
            	<i class="layui-icon">&#xe619;</i>  
                                      导出
            </button>
            
               <!--费用评估-->
            <button class="layui-btn layui-btn-sm"onclick="fypg()" style="margin-left:3%;">
            	<i class="layui-icon">&#xe65e;</i>  
                                     费用评估
            </button>
            
                 <!--网络评估-->
            <button class="layui-btn layui-btn-sm"onclick="wlpg()" style="margin-left:3%;">
            	<i class="layui-icon">&#xe7ae;</i>  
                                     网络评估
            </button>
  ...
  <!--   <div class="layui-btn-group demoTable" style="margin-top: 2px;">
    ...
    <div class="layui-row"  style="height: 48%;overflow: auto; background-color: #ffffff">
       <div class="layui-col-md12" >
    <table class="layui-table" lay-data="{url:'DepartmentApply',size: 'sm',page: { 
...
<script type="text/html" id="barDemo">
 <div id="bjtest">
  ...
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
   ...
   <!--顶部结束  -->
   <!-- 中部开始 -->
   <div class="layui-row"  style="height: 1%;overflow: auto; ">
       <div class="layui-col-md12" >
   ...
   <!-- 底部开始 -->
    ...
    url:'DepartmentApply',size: 'sm',page: { 
     layout: ['limit', 'count', 'prev', 'page', 'next', 'skip']
    ,limits:[5,10, 20, 30, 40, 50]
    ,limit:5
      ,groups: 1  
