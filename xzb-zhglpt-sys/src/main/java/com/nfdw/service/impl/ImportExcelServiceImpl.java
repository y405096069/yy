...
public class ImportExcelServiceImpl extends ImportExcelBaseService implements ImportExcelService {
    ...
    public List<Achievement_Summary> importExcelWithSimple(MultipartFile file, HttpServletRequest req, HttpServletResponse resp) {
        ...
        for(Row row:sheet) {
            ...
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setNational_same_name(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
            ...
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setProvincial_same_name(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
            ...
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setQualified_line(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
    ...
    @Override
    public List<Achievement_Summary> importExcelWithSimple2(MultipartFile file, HttpServletRequest req, HttpServletResponse resp) {
        int rowNum = 0;//已取值的行数
        int colNum = 0;//列号
        int realRowCount = 0;//真正有数据的行数
        ...
        for(Row row:sheet) {
            ...
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_national_rankings(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_national_same_name(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_provincial_ranking(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_provincial_same_name(Integer.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_qualified_mark(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_qualified_line(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;

            //科目1
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name1(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve1(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex1(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            //科目2
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name2(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve2(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex2(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            //科目3
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name3(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve3(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex3(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            //科目4
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name4(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve4(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex4(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            //科目5
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name5(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve5(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex5(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            //科目6
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_name6(super.getCellValue(sheet, row, colNum));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve6(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_achieve_ex6(super.getCellValue(sheet, row, colNum));
            }
            colNum++;

            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setComplex_subjects_total(Double.valueOf(super.getCellValue(sheet, row, colNum)));
            }
            colNum++;
            if (super.getCellValue(sheet, row, colNum) !=null && super.getCellValue(sheet, row, colNum) !=""){
                as.setRe_remarks(super.getCellValue(sheet, row, colNum));
            }
