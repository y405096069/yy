...
public interface StudentInformationMapper {
    ...
    //按学生用户和当前日期查找报考信息
    List<Examination> getListExamination(@Param("currentDate")String currentDate,@Param("examinee_province")String examinee_province,
                                         @Param("subject_type")String subject_type,@Param("examName")String examName,@Param("subjectName")String subjectName,
                                         @Param("create_start_time")String create_start_time);
    //学生上传文件审核
