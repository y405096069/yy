...
/*
       导出复试入围成绩
     */
public class CutExportToExcel2 {


    public static void exportWhiteList( List<Achievement_Summary> list, HttpServletResponse response) {
        ...
        try {
            ...
            for (Achievement_Summary as : list) {
                ...
                if(as.getNational_rankings()!=0)
                    nCell.setCellValue(as.getRe_national_rankings());nCell.setCellStyle(style2);
                //全国同名次
                nCell = nRow.createCell(colNo++);
                if(as.getNational_same_name()!=0)
                    nCell.setCellValue(as.getRe_national_same_name());
                //省排名
                nCell = nRow.createCell(colNo++);
                if(as.getProvincial_ranking()!=0)
                    nCell.setCellValue(as.getRe_provincial_ranking());
                //省同名次
                nCell = nRow.createCell(colNo++);
                if(as.getProvincial_same_name()!=0)
                    nCell.setCellValue(as.getRe_provincial_same_name());
                //合格标志Y/N
                nCell = nRow.createCell(colNo++);
                if(as.getQualified_mark()!=null)
                    nCell.setCellValue(as.getRe_qualified_mark());
                //合格线
                nCell = nRow.createCell(colNo++);
                if(as.getQualified_line()!=0)
                    nCell.setCellValue(as.getRe_qualified_line());
                ...
                if (as.getComplex_subjects_achieve1()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve1());
                //科目1成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex1()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex1());
                ...
                //科目2成绩
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve2()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve2());
                //科目2成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex2()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex2());
                ...
                //科目3成绩
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve3()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve3());
                //科目3成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex3()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex3());
                ...
                //科目4成绩
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve4()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve4());
                //科目4成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex4()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex4());
                ...
                //科目5成绩
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve5()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve5());
                //科目5成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex5()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex5());
                ...
                //科目6成绩
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve6()!=0)
                    nCell.setCellValue(as.getComplex_subjects_achieve6());
                //科目6成绩说明
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_achieve_ex6()!=null)
                    nCell.setCellValue(as.getComplex_subjects_achieve_ex6());
                ...
                //复试总分
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getComplex_subjects_total()!=0)
                    nCell.setCellValue(as.getComplex_subjects_total());

                //总分
                nCell = nRow.createCell(colNo++);nCell.setCellStyle(style2);
                if (as.getTotal_score()!=0)
                    nCell.setCellValue(as.getTotal_score());
     ...
     * @throws IOException
     */
    private static void loadResponse(HttpServletResponse response, HSSFWorkbook wb) throws IOException {
        ...
        String outFile = "复试入围成绩表" + dateTime + ".xls";
        //设置返回的文件类型
