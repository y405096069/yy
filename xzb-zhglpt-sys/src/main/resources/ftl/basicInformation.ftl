...
<head>
    ...
    <style>
        ...
        .layui-row .layui-form .layui-icon {
            font-size: 20px;
            cursor: pointer;
        }
        .layui-row .layui-form .layui-icon:hover {
            color:red;
        }
        .pad {
            min-height: 150px;
        ...
        <form class="layui-form" method="post" action="${re.contextPath}/studentInformation/addStudentInformations" enctype="multipart/form-data">
            ...
            <div>
                <div style="display: flex;justify-content: center;align-items: center;min-height: 80px;">
                    <button style="width: 150px;height: 40px;" type="submit" class="layui-btn" lay-submit="" lay-filter="submits">确定</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    function addAction() {
        $('#family-box').append(` <div class="layui-form-item" id="one">
                        <div class="layui-inline">
                            <label for="uname" class="layui-form-label">
                                    <span class="x-red">*</span>姓名
                            </label>
