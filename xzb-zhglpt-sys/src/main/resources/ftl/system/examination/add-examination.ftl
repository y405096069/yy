    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <label class="layui-form-label">请输入考试开始时间</label>
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="test1" placeholder="yyyy-MM-dd">
                </div>
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="test4" placeholder="请输入考试结束时间">
                </div>
                <div class="layui-input-inline">
                    <input type="text" id="uname" name="username" lay-verify="username"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" id="switchTest" lay-filter="switchTest" name="switchTest" lay-skin="switch" lay-text="是|否">
                </div>
            </div>
            <div class="layui-inline">
           ...
           <#-- <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="min-width: 300px">
                    <input type="radio" name="sex" value="1" title="文科">
                    <input type="radio" name="sex" value="0" title="理科">
                </div>
            </div>-->
        </div>
        <div class="major">
    ...
    function addAction() {
        $('.active').append(
            `<div class="layui-form-item one">
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" id="test3" placeholder="请输入考试开始时间">
                    </div>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" id="test4" placeholder="请输入考试结束时间">
                    </div>
