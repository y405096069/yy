    ...
    <form class="layui-form" action="">
         <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="exam" name="exam" lay-verify="username"
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                   <input type="text" class="layui-input" id="exam_time" name="exam_time" placeholder="请输入报名开始时间">
                </div>
            </div>
             <div class="layui-inline">
                <label for="uname" class="layui-form-label w-16">
                ...
                <div class="layui-input-inline">
                   <input type="text" class="layui-input" id="end_time" name="end_time" placeholder="请输入报名截止时间">
                </div>
            </div>
        </div>
          <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="specialty_name" id="specialty_name" class="spec_id" lay-verify="spec_id"
                            lay-filter="spec_id">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="create_time" name="create_time" placeholder="请输入考试开始时间">
                </div>
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="update_time" name="update_time" placeholder="请输入考试结束时间">
                </div>
                <div class="layui-input-inline">
                    <input type="text" id="number_limitation" name="number_limitation" lay-verify="username"
                            autocomplete="off" class="layui-input" placeholder="请输入报考人数">
                </div>
                 <div class="layui-input-inline">
                    <input type="text" id="build" name="build" lay-verify="username"
       ...
       <div class="active" style="margin-left: 110px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="prcie" name="prcie" lay-verify="username"
       ...
       <div class="layui-form-item">
        ...
        <div class="reexamine">
         ...
         <div class="layui-input-inline">
                    <select name="gathering_id" id="gathering_id" lay-verify="departmentId"
                        ...
                        <option value="无">请选择信息采集模板</option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="uname" name="prologue" lay-verify="username"
