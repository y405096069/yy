    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="name" id="name" class="name" lay-verify="name"
                            lay-filter="name">
                        <option value="">请选择专业</option>
                        <#list specManagementList as spe>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="code" id="code" class="code" lay-verify="code"
                            lay-filter="code">
                        <option value="">请选择专业代码</option>
                        <#list specManagementList as spe>
                            <option value="${spe.id}">${spe.code}</option>
                        </#list>
                    </select>
                </div>
            </div>
