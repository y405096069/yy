    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'complex_subjects_achieve2', title: '科目2成绩', width: 100}
                , {field: 'complex_subjects_name3', title: '科目3名称', width: 100}
                , {field: 'complex_subjects_achieve3', title: '科目3成绩', width: 100}
                , {field: 'complex_subjects_name4', title: '科目4名称', width: 100}
                , {field: 'complex_subjects_achieve4', title: '科目4成绩', width: 100}
                , {field: 'complex_subjects_name5', title: '科目5名称', width: 100}
