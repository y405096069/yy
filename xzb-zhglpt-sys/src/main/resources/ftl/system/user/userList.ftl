    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'email', title: '电话', width: '13%'}
                , {field: 'photo', title: '头像', width: '13%', template: '#switchTpl'}
                , {field: 'departmentName', title: '区域', width: '13%'}
        ...
        table.on('tool(user)', function (obj) {
            var data = obj.data;
            if (obj.event === 'detail') {
                detail('查看用户', 'updateUser?id=' + data.id, 700, 600);
                ...
                update('编辑用户', 'updateUser?id=' + data.id, 700, 600);
            }
        });
