...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.verify({
            ...
            , url: function (v) {
                if (type.val() == '0') {//xiugai
                    $('#url').val('');
                }
                if (type.val() == '3' && v.trim() == '') {//xiugai
                    return 'url不能为空';
                }
            }
            , permission: function (v) {
                if ((type.val() == '1' || type.val() == '3') && v.trim() == '') {//xiugai
                    return '权限不能为空';
                }
            }
