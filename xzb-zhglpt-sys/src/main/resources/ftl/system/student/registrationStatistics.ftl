        ...
        function bindData(){
            ...
            $.ajax({
                ...
                success:function(echartData){
                    if(echartData){
                        var auditedList=echartData.auditedList[0]
                        var numberApplicantsList=echartData.numberApplicantsList[0]
                        var paidList=echartData.paidList[0]
                        var pendingPaymentList=echartData.pendingPaymentList[0]
//                        var signUpSuccessList=echartData.signUpSuccessList[0]
                        var pendingReviewList=echartData.pendingReviewList[0]
                        myChart.setOption({
                            color: ['#3398DB'],
                            tooltip : {
                                trigger: 'axis',
                            ...
                            series : [
                                {
                                    ...
                                    type:'bar',
                                    barWidth: '60%',
                                    data:[numberApplicantsList,pendingReviewList,auditedList,pendingPaymentList,paidList],
                                    label:{
                                        normal:{
                                            show: true,
                                            position: 'inside'
