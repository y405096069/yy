        ...
        function bindData(){
            ...
            $.ajax({
                ...
                success:function(echartData){
                    if(echartData){
                        var manList=echartData.manList[0]
                        var goddessList=echartData.goddessList[0]
                        var freshGraduateList=echartData.formerGraduateList[0]
                        var formerGraduateList=echartData.formerGraduateList[0]
                        var ethnicHanList=echartData.ethnicHanList[0]
                        var nationalMinorityList=echartData.nationalMinorityList[0]
                        var scienceList=echartData.scienceList[0]
                        var artsList=echartData.artsList[0]
                        myChart.setOption({
                            color: ['#3398DB'],
                            tooltip : {
                                trigger: 'axis',
                            ...
                            xAxis : [
                                {
                                    type : 'category',
                                    data : ['男', '女', '应届生','往届生','汉族','少数民族','理科','文科'],
                                    axisTick: {
                                        alignWithLabel: true
                                    }
                                }
                            ...
                            series : [
                                {
                                    ...
                                    type:'bar',
                                    barWidth: '60%',
                                    data:[manList,goddessList,freshGraduateList,formerGraduateList,ethnicHanList,nationalMinorityList,scienceList,artsList],
                                    label:{
                                        normal:{
                                            show: true,
                                            position: 'inside'
