...
<div class="layui-row layui-form-pane">
    <div style="text-align: center;width: 700px; margin: 0 auto;">
        <input type="text" value="广州大学2019年语文类校考准考证" style="width: 60%;height:50px;text-align:center;font-size: 20px;border: none;margin: 0 auto;"/>
    </div>
            
    <div class="pupop" style="background-size: 50%;">
        <div class="pupop-box">
            <div style="text-align: center;width: 100%;">
                <input type="text" value="广州大学2019年语文类校考准考证" style="background: center;width: 60%;height:50px;text-align:center;size:32px;border: 1px dashed #000;margin: 0 auto;"/>
            </div>
            <div class="pupop_content">
                <div class="content_left">
                    <p><span>姓名:叶生</span><span style="margin-left: 60px;">性别: 男</span></p>
            ...
            <table class="layui-table" style="border: 2px solid #000;background-color: rgba(0,0,0,0);pointer-events: none;">
                <colgroup>
                    <col width="120">
                    <col width="150">
                    <col>
        ...
        <div style="display: flex;justify-content: center;align-items: center;min-height: 60px;">
            ...
            <button id="btn2" style="width: 150px;height: 40px;" type="button" class="layui-btn" onclick="window.print()">提交</button>
