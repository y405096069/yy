...
<div class="x-body">
    <div class="layui-form layui-form-pane" style="margin: 20px;">
        <div style="width:100%;overflow: auto;min-height: 800px;">
            ...
            <div class="layui-form-item" style="width: 500px;">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" id="title" lay-verify="title" placeholder="请输入标题" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        ...
        <#--<div class="layui-row">-->
            <div class="layui-form-item" style="width: 500px;">
                <div class="layui-inline layui-col-md6" style="width: 390px;margin-right: 0; ">
                    <label class="layui-form-label" style="overflow: auto">发布信息类型</label>
                    <div class="layui-input-inline layui-col-md10">
                        <select name="informationType" id="informationType" lay-filter="informationType"
            ...
            <div class="layui-form-item" style="width: 500px;">
                <div class="layui-inline layui-col-md6" style="width: 100%;">
